 ...
 */
#define CMD4_MID         CFE_MAKE_BIG16(ARDRONE2_PLAT_CMD_MID) /* command message ID */
#define CMD4_SIZE_BE     CFE_MAKE_BIG16((sizeof(ARDrone2_anim_cmd_t))-7) /* size */

static ARDrone2_anim_cmd_t cmd4_str RETAIN_SYMBOL = { { {
/* primary message header */
...
/* payload: */
1U,     /* sequence  - animation sequence (1-21) */
2U,     /* duration  - in seconds */
5.0 };  /* frequency - in Hz  */
