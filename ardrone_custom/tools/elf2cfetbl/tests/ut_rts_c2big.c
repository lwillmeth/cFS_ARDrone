...
**  agreement.
**
**  elf2cfetbl test: message too big (malformed)
**
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef RETAIN_SYMBOL = {
		...
		"ut_rts_c2big.tbl", (SC_RTS_BUFF_SIZE * sizeof(uint16)) };
...
static uint8 WayTooBig[65535] RETAIN_SYMBOL = {};
