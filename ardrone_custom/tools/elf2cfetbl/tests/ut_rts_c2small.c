...
**  agreement.
**
**  elf2cfetbl test: message too small (malformed)
**
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef RETAIN_SYMBOL = {
		...
		"ut_rts_c2small.tbl", (SC_RTS_BUFF_SIZE * sizeof(uint16)) };
...
static uint8 WayTooSmall[5] RETAIN_SYMBOL = {};
...
static RTS_List_Entry SCCommandList[NUM_CMDS] RETAIN_SYMBOL =
	{ { 0, "sc_noop", sizeof(sc_noop) },
	  ...
	  { 5, "WayTooSmall", sizeof(WayTooSmall) } };
