...
**
** $Log: sc_ats1.c  $
** Revision 1.9 2016/03/25 abrown
** Updated for BE & LE builds.
...
#define CMD1_TIME_B   ((uint16) ((uint32) CMD1_TIME >> 16))
#define CMD2_TIME_B   ((uint16) ((uint32) CMD2_TIME >> 16))
#define CMD3_TIME_B   ((uint16) ((uint32) CMD3_TIME >> 16))
#define CMD4_TIME_B   ((uint16) ((uint32) CMD4_TIME >> 16))

#define CMD1_TIME_A   ((uint16) ((uint32) CMD1_TIME))
#define CMD2_TIME_A   ((uint16) ((uint32) CMD2_TIME))
#define CMD3_TIME_A   ((uint16) ((uint32) CMD3_TIME))
#define CMD4_TIME_A   ((uint16) ((uint32) CMD4_TIME))
