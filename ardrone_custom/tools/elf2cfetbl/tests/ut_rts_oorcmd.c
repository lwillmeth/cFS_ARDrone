...
**  agreement.
**
**  elf2cfetbl test: empty SCCommandList, out of range SCCommandList_NUM_CMDS
**
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef RETAIN_SYMBOL = {
		...
		"ut_rts_oorcmd.tbl", (SC_RTS_BUFF_SIZE * sizeof(uint16)) };
...
static const uint16 SCCommandList_NUM_CMDS RETAIN_SYMBOL = (35565U);
