...
**  agreement.
**
**  elf2cfetbl test: empty SCCommandList, bad SCPacketMaxSize symbol
**
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef RETAIN_SYMBOL = {
		...
		"ut_rts_badmax.tbl", (SC_RTS_BUFF_SIZE * sizeof(uint16)) };
...
static uint16 SCPacketMaxSizeXYZ RETAIN_SYMBOL = (SC_PACKET_MAX_SIZE);  /* BAD SYMBOL NAME */
