...
/*{ { CFE_MAKE_BIG16(MD_WAKEUP_MID),            CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
  ...
  */
  ...
  { { CFE_MAKE_BIG16(CI_LAB_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #31 - Telemetry Output HK Request Example */
  { { CFE_MAKE_BIG16(TO_LAB_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #32 - ARDRONE2 APP HK */
  { { CFE_MAKE_BIG16(ARDRONE2_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #33 - ARDRONE2 APP Wakeup */
  { { CFE_MAKE_BIG16(ARDRONE2_WAKEUP_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #34 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },  
    /* command ID #35 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
