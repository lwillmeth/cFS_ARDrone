...
# set correctly.
#
# This script modified for AR Drone 2015.
#
#
...
#
# Note, for the AR Drone, we have some apps that are
# used unmodified between tutorials/demos and some that
# are modified.
export APP_DIR=$CFS_MISSION/../ardrone_custom/apps
...
#
# Note, for the AR DRone, we have platform-specific customizations.
# So we use a copy of the open-source cFE:
export CFE_DIR=$CFS_MISSION/../ardrone_custom/cfe
...
#
# Note, for the AR DRone, we have minor OSAL customizations.
# So we use a copy of the open-source OSAL:
export OSAL_DIR=$CFS_MISSION/../ardrone_custom/osal
...
#
# For AR DRone, we introduce a new PSP:
export PSP_DIR=$CFS_MISSION/../ardrone_custom/psp
...
export CFE_TOOLS=$CFS_MISSION/../ardrone_custom/tools
